                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            @else
                                <img alt="" class="margin-auto-div img-rounded profile-user-img img-fluid img-circle" src="{{ asset('admin/dist/img/avatar3.jpg') }}" id="image_render" style="height: 150px; width:150px;">
                            @endif
                        </div>
                        @if (isset($user->name))
                        ...
                        @endif
                        @if (isset($user->roles))
                            <p class="text-muted text-center">{{ isset($user->roles[0]) ? $user->roles[0]->display_name : '' }}</p>
                        @endif
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="settings">
                                <div class="form-group row">
                                    <label for="inputName" class="col col-form-label">Họ và tên  <sup class="title-sup">(*)</sup></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail" class="col col-form-label">Email  <sup class="title-sup">(*)</sup></label>
                                    <div class="col-sm-10">
                                ...
                                @if( !isset($user->password) && empty($user->password))
                                    <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                                        <label for="inputName2" class="col col-form-label">Mật khẩu  <sup class="title-sup">(*)</sup></label>
                                        <div class="col-sm-10">
                                ...
                                @endif
                                <div class="form-group row">
                                    <label for="inputName2" class="col col-form-label">Phone  <sup class="title-sup">(*)</sup></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="inputName2" class="col col-form-label"> <sup class="title-sup"></sup></label>
                                    <div class="col-sm-10">
                                        <h2>Chọn vai trò cho nhân viên <sup class="title-sup">(*)</sup></h2>
                                        @foreach($roles as $role)
                                            <label>
                                                <input type="checkbox" name="selected_roles[]" value="{{ $role->id }}"
                                                @if(isset($user) && in_array($role->id, $user->roles->pluck('id')->toArray())) checked @endif>
                                                {{ $role->display_name }}
                                            </label><br>
                                        @endforeach
                                        <span class="text-danger"><p class="mg-t-5">{{ $errors->first('roles') }}</p></span>
                                    </div>
                                </div>
                                
                                
                                <div class="form-group row">
                                    <label for="inputName2" class="col col-form-label">Trạng thái  </label>
                                    <div class="col-sm-10">
