                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="h_location_id" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control"  placeholder="Số lượng" name="h_number" value="{{ old('h_number',isset($hotel) ? $hotel->h_number : '') }}">
                                    <span class="text-danger "><p class="mg-t-5">{{ $errors->first('h_number') }}</p></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Địa chỉ</label>
