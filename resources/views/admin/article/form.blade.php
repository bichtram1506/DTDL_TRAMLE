                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('a_title') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tên bài viết <sup class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="180" class="form-control"  placeholder="Tên bài viết" name="a_title" value="{{ old('a_title',isset($article) ? $article->a_title : '') }}">
