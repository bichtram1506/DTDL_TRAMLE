<div style="background-color:#F7F7F7; border: 1px solid #ECECEC; padding: 20px;">
    ...
    <p style="text-align: center;">Chúng tôi xin trân trọng thông báo rằng đơn đặt tour của quý khách đã được xác nhận thành công. Chúng tôi sẽ cùng quý khách trải qua một hành trình đáng nhớ và đầy ấn tượng. Hãy chuẩn bị sẵn sàng để khám phá những trải nghiệm tuyệt vời mà chúng tôi mang đến!</p>    
    <hr style="margin: 20px 0;">
    <h3 style="color: #0077B5; font-weight: bold;">Phiếu xác nhận Booking: <span style="border: 2px solid red; color: red; padding: 2px;">CHƯA THANH TOÁN</span></h3>
    <div style="background-color:#fff; border: 1px solid #ECECEC; padding: 20px;">
            ...
            <hr style="margin: 20px 0;">
            <p><b>Mã booking:</b> <span style="">{{ $bookTour->id }}</span></p>
...
<!-- Thêm các thông tin khác của chi tiết đợt tour tại đây -->
      ...
      @elseif ($bookTour->b_payment_method === 'VNPay')
          ...
          <p style="margin-bottom: 10px;">
              <a href="{{ route('process_payment_momo') }}?booktourId={{ $bookTour->id }}&b_total_price={{ $bookTour->b_total_price }}">Tiếp tục thanh toán</a>
          </p>
    ...
    @endif
      ...
      <p><b>Thời hạn thanh toán:</b> 2 ngày sau xác nhận</p>
   <b style="color:red"> Nếu quá thời hạn trên, quý khách chưa thanh toán, VietScapeJourneys sẽ huỷ booking này</b>
  </div>
  <hr style="margin: 20px 0;">
