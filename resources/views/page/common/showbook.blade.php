    ...
    <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="detail">
                    ...
                    <p><b><i class="fas fa-route"></i> Tour</b>: 
                        ...
                        <a href="{{ route('tour.detail', ['id' => $bookTour->eventdate->tour->id, 'slug' => safeTitle( $bookTour->eventdate->tour->t_title)]) }}">{{  $bookTour->eventdate->tour->t_title }}</a></p>
                    </p> 
                    <p><b><i class="far fa-calendar-alt"></i> Ngày dự kiến</b>: {{ $bookTour->eventdate->td_start_date }}</p>
                </div>
            ...
            @endif
                ...
                @elseif ($bookTour->b_payment_method === 'bankTransfer')
                    ...
                    <i class="fa fa-university"></i> Ví MOMO
                @endif
                </p>
