        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ftco-animate py-md-5 mt-md-5 fadeInUp ftco-animated">
                    <h2 class="article-title">{{ $article->a_title }}</h2>
                    <div class="article-content">
                        <p class="article-description">
                            {!! $article->a_description !!}
                        </p>
                        <img src="{{ $article->a_avatar ? asset(pare_url_file($article->a_avatar)) : asset('admin/dist/img/no-image.png') }}" alt="{{ $article->a_title }}" class="article-image img-fluid">
                    </div>
                    <div class="content">
                        {!! $article->a_content !!}
                                ...
                                @if (Auth::guard('users')->check())
                                    <form action="#" class="p-5 bg-light">
                                        <div class="form-group">
                                            ...
                                            <span class="text-errors-comment" style="display: none;">Bình luận !!!</span>
                                        </div>
                                        <div class="form-group">
                                            <input type="submit" value="Gửi bình luận" class="btn py-3 px-4 btn-primary btn-comment" article_id="{{ $article->id }}">
                                        </div>
                                    </form>
                                @endif
                            </div>
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        <div class="categories">
                            ...
                            @foreach($categories as $category)
                                <li><a href="{{ route('articles.showByCategory', ['id' => $category->id]) }} ">{{ $category->c_name }}
                                ...
                                <div class="block-21 mb-4 d-flex">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="meta">
                                            ...
                                            <div><a href="#"><span class="fa fa-user"></span> {{ $article->staff ? $article->staff->name : '' }}</a></div>
