    ...
    public function index(Request $request)
    {
        ...
        $comments = Comment::with('user')->whereIn('cm_user_id', function ($q) use($request) {
            ...
            if ($request->searchType) {
                if ($request->searchType === 'cm_tour_id') {
                    $q->whereNotNull('cm_tour_id');
                }
                if ($request->searchType === 'cm_article_id') {
                    $q->whereNotNull('cm_article_id');
                }
                if ($request->searchType === 'cm_hotel_id') {
                    $q->whereNotNull('cm_hotel_id');
                }
            }
